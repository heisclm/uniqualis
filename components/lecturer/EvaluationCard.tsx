      ...
      <div className="p-6 md:p-8">
        ...
        {evaluation.lecturerResponse ? (
          <div className="ml-4 md:ml-8 relative mt-4">
            <div className="absolute -left-4 md:-left-8 top-6 bottom-0 w-px bg-indigo-100"></div>
            <div className="absolute -left-4 md:-left-8 top-6 w-4 md:w-8 h-px bg-indigo-100"></div>
            
            <div className="bg-indigo-50/50 rounded-2xl p-5 border border-indigo-100/50 relative">
              <div className="flex items-center gap-2 mb-3">
                <ShieldCheck className="w-4 h-4 text-indigo-500" />
                <span className="text-xs font-bold text-indigo-900 uppercase tracking-wide">QA Action Plan Submitted</span>
          ...
          <div className="ml-4 md:ml-8 mt-4 animate-in fade-in slide-in-from-top-2">
            ...
            <textarea 
              ...
              className="w-full bg-white border border-indigo-200 text-slate-700 rounded-2xl px-5 py-4 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-all resize-none shadow-sm shadow-indigo-100/50 mb-4"
            ></textarea>
          ...
          <div className="flex justify-end mt-4">
            <button 
              ...
              className="flex items-center gap-2 px-4 py-2 text-sm font-semibold text-indigo-600 bg-indigo-50 rounded-lg hover:bg-indigo-100 hover:text-indigo-700 transition-colors"
            >
